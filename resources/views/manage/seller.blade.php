...
@section('content')
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stat_product }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stat_category }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stat_transaction }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Transaksi Gagal</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stat_canceled }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="card mb-3">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-info-circle fa-fw"></i> Data Transaksi Saat Ini</h6>
        </div>
        <div class="card-body">
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card mb-3 bg-default">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-coins fa-fw"></i> Kilasan Nilai Penjualan</h6>
                </div>
                <div class="card-body">
                    <!-- Chart -->
                    <div class="chart">
        ...
        <div class="col-xl-4">
            <div class="card mb-3">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-percentage fa-fw"></i> Persentase Kualitas Transaksi</h6>
                </div>
                <div class="card-body">
                    <!-- Chart -->
                    <div class="chart">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function (){
            ...
            var salesChart = new Chart($('#chart-sales-dark'), {
                type: 'line',
                data: {
            ...
            var ordersChart = new Chart($('#chart-bars'), {
                type: 'bar',
                data: {
                ...
                options: {
                    ...
                    tooltips: {
                        ...
                        callbacks: {
                            label: function(tooltipItem, chart) {
                                var datasetLabel = chart.datasets[tooltipItem.datasetIndex].label || '';
                                return datasetLabel + ' ' + Math.round(tooltipItem.yLabel * 100) + '%';
                            }
                        }
                    }
                }
